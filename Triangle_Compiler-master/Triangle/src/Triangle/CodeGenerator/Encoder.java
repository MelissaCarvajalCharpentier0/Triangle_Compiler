...
public final class Encoder implements Visitor {
  ...
  public Object visitProcTypeDenoter(ProcTypeDenoter ast, Object o) {
    ...
    // Visitar el identificador del procedimiento (puedes usar otros métodos de logging si es necesario)
    if (ast.I != null) {
      // emitComment("Procedimiento: " + ast.I.spelling); // Temporalmente comentado
      System.out.println("Procedimiento: " + ast.I.spelling); // Alternativa para debugging
    }
    ...
    // Visitar el comando del cuerpo del procedimiento
    if (ast.C != null) {
      ast.C.visit(this, o);
    }
    ...
    return new Integer(typeSize); // Devuelve el tamaño del tipo del procedimiento
  }
  ...
  public Object visitRepeatCommand(RepeatCommand ast, Object o) {
    Frame frame = (Frame) o;
    int loopAddr, exitAddr;

    // Dirección del inicio del bucle
    loopAddr = nextInstrAddr;
    ast.C.visit(this, frame); // Visitar el comando repetido
