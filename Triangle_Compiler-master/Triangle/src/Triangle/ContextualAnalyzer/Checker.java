...
public final class Checker implements Visitor {
  ...
  public Object visitProcTypeDenoter(ProcTypeDenoter ast, Object o) {
    ...
    ast.FPS = (FormalParameterSequence) ast.FPS.visit(this, null);

    // Verificar el comando del cuerpo del procedimiento
    ast.C.visit(this, null);
  ...
  public Object visitRepeatCommand(RepeatCommand ast, Object o) {
    ...
    // Visitar el comando repetido
    ast.C.visit(this, null);

    // Verificar que la expresión de condición es de tipo boolean
    TypeDenoter eType = (TypeDenoter) ast.E.visit(this, null);
    if (!eType.equals(StdEnvironment.booleanType)) {
      reporter.reportError("incompatible expression type (Boolean Expression expected)", "", ast.E.position);
    }
