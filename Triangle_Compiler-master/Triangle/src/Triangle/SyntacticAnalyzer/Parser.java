  ...
  Command parseSingleCommand() throws SyntaxError {
    ...
    case Token.WHILE:
      ...
      case Token.FOR:
      {
        ...
        Command cAST = parseSingleCommand();
        finish(commandPos);
        commandAST = new ForCommand(vAST, e1AST, e2AST, iLAST,  cAST, commandPos);
      }
      break;
      case Token.REPEAT:{
        acceptIt();
  ...
  TypeDenoter parseTypeDenoter() throws SyntaxError {
    ...
    case Token.RECORD:
      ...
      case Token.PROC:{
        ...
        accept(Token.RPAREN);
        accept(Token.IS);
        Command commandAST = parseSingleCommand();
        finish(typePos);
        typeAST = new ProcTypeDenoter(iAST,fAST,commandAST,typePos);
      }
      break;
      ...
      case Token.FUNC:{
        ...
        Expression eAST = parseExpression();
        finish(typePos);
        typeAST= new FuncTypeDenoter(fAST,tAST,eAST,typePos);
      }
      break;
